...
let jour = prompt("Quel jour souhaitez vous prendre rendez-vous?");
  ...
  while(horaireDeRdv!=="1" && horaireDeRdv!=="2" && horaireDeRdv!=="3" && horaireDeRdv!=="4" && horaireDeRdv!=="5" && horaireDeRdv!=="6" && horaireDeRdv!=="7" && horaireDeRdv!=="8" && horaireDeRdv!=="9" && horaireDeRdv!=="10"){
    horaireDeRdv = prompt("Tapez le chiffre correspondant à l'horaire désirée:\n1/9H00-10H00\n2/10H00-11H00\n3/11H00-12H00\n4/12H00-13H00\n5/13H00-14H00\n6/14H00-15H00\n7/15H00-16H00\n8/16H00-17H00\n9/17H00-18H00\n10/18H00-19H00")
  }
  switch(horaireDeRdv){
    case "1":
     confirm("Vous désirez une consultation de 9H00 à 10H00?");
      break;
    case "2":
     confirm("Vous désirez une consultation de 10H00 à 11H00?");
      break;
    case "3":
     confirm("Vous désirez une consultation de 11H00 à 12H00?");
      break;
    case "4":
      confirm("Vous désirez une consultation de 12H00 à 13H00?");
      break;
    case "5":
      confirm("Vous désirez une consultation de 13H00 à 14H00?");
      break;
    case "6":
      confirm("Vous désirez une consultation de 14H00 à 15H00?");
      break;
    case "7":
      confirm("Vous désirez une consultation de 15H00 à 16H00?");
      break;
    case "8":
      confirm("Vous désirez une consultation de 16H00 à 17H00?");
      break;
    case "9":
      confirm("Vous désirez une consultation de 17H00 à 18H00?");
      break;
    case "10":
      confirm("Vous désirez une consultation de 18H00 à 19H00");
      break;
    default:
